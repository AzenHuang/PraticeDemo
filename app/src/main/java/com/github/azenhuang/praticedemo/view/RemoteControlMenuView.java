...
/**
 * Created by huangyongzheng on 2/14/17.
 */

public class RemoteControlMenuView extends View {
    private static final String TAG = RemoteControlMenuView.class.getSimpleName();
    ...
    public RemoteControlMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mDefaultPaint.setColor(mDefautColor);
